  ...
  return (
    <main className='flex w-full flex-col items-center justify-center'>
        <PageLayout className='pt-16'>
            <>
                <Text text="Passion Fuels Purpose!" className='mb-16'/>
...
creating intuitive, enjoyable experiences for users. </p>
                        <p className='my-4 font-medium'>Whether I am working on a website, mobile app, or 
...
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.</p>
                    ...
                    <div className='col-span-2 flex flex-col items-end justify-between '>
                        ...
                        <div className='flex flex-col items-end justify-center'>
                            ...
                            <h2 className='text-xl font-medium capitalize text-dark/75'>projects complited</h2>
                        </div>
                        <div className='flex flex-col items-end justify-center'>
                            <span className='inline-block text-7xl font-bold'>
                                4+
